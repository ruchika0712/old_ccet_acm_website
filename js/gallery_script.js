(function ($) {
	...
	if ($('.mobile-menu').length) {
		...
		var maganzineContent = $('.main-header .nav-outer .outer-box.clearfix').html()

		$('.mobile-menu .menu-box .menu-outer').append(mobileMenuContent);
		$('.mobile-menu .menu-box .menu-outer').append(maganzineContent);
		
		$('.sticky-header .main-menu').append(mobileMenuContent);
		$('.sticky-header .main-menu').append(maganzineContent);
	...
	if ($('.accordion-box').length) {
		...
		$(".accordion-box").on('click', '.acc-btn', function () {
			...
			if ($(this).next('.acc-content').is(':visible')) {
				...
				$(outerBox).find('.accordion').children('.acc-content').slideDown(300);
